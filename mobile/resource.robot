...
&{Home}                  icone_busca=accessibility_id=Search                  
                         ...
                         icone_subscriptions=accessibility_id=icone_subscriptions
                         icone_notifications=accessibility_id=icone_notifications
                         icone_library=accessibility_id=Library

&{Resultados_busca}      canais_sugeridos=chanel_item
...
Buscar o canal “${buscar_canal}” 
    [Documentation]    Keyword responsavel por fazer uma busca dentro do youtube app e a partir de uma string
     ...
     Input Text                             ${Home.icone_busca}                 ${buscar_canal}
     Press Keycode                          66
...
Selecionar a primeira playlist do canal
    ...
    @{lista_playlist}                       Get WebElements   ${Canais.lista_playlist}
     Click Element                          ${Canais.lista_playlist} [0]
